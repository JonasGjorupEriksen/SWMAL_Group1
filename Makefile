...
.PHONY:tar
tar:
	cd ~ && tar  --exclude=*~ --exclude=.git --exclude=.ipynb_checkpoints --exclude=__pycache__ --exclude=.git --exclude=Yolov5_setup --exclude=*_v*.ipynb --exclude=GITMAL/L11/NanoGPT/Slides* --exclude=Old -czf gitmal_E24.tgz GITMAL/* 
